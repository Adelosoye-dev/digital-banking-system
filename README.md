...
npm install                 # already done if you received the folder with node_modules

# 1. Register your bank with NibssByPhoenix (one time). Credentials arrive by email.
npm run onboard -- --name "Your Bank Name" --email you@example.com

# 2. Paste the credentials into .env
#    NIBSS_API_KEY=...
#    NIBSS_API_SECRET=...
